...
'''MemeGenerator module with the following responsibilities:
    ...
    Transforms image by resizing to a maximum width of 500px while maintaining the input aspect ratio.
    Adds a caption to an image (string input) with a body and author to a random location on the image.
'''
class MemeEngine():
    def __init__(self, out_dir):
        ...
        Returns:
            str -- the file path the output image.
        """
